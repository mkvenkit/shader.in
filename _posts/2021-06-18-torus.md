...
5. Create a 
6. Render the object using *glDrawArrays()* or similar calls.
...
In Eq. 1, \(R\) is the outer radius of the torus, \(r\) is the tube radius, $u$ is the angle made by a ring on the torus 
